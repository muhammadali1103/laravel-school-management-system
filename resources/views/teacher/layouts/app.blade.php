...
<head>
    ...
    <title>@yield('title', 'Teacher Panel') - School Management System</title>
...
<body>
                ...
                @can('notification.view')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('teacher.notifications.*') ? 'active' : '' }}"
                            ...
                            @if(isset($teacherNotificationCount) && $teacherNotificationCount > 0)
                                <span class="badge bg-danger ms-2">{{ $teacherNotificationCount }}</span>
                            @endif
                        </a>
                    </li>
                @endcan
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-4 p-2 mt-2"
                        ...
                        <li>
                            <a class="dropdown-item rounded-2 py-2 mb-1" href="{{ route('teacher.profile.edit') }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const scrollPos = localStorage.getItem('sidebarScrollPos_teacher');
            if (scrollPos) {
            ...
            sidebarContent.addEventListener('scroll', function () {
                localStorage.setItem('sidebarScrollPos_teacher', this.scrollTop);
            });
        });
    </script>
    @yield('scripts')
